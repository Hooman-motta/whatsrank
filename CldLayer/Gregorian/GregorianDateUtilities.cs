...
namespace CldLayer.Gregorian {
    /// <summary>
    /// متدهای کمکی جهت کار با تاریخ میلادی
    /// </summary>
    public static class GregorianDateUtilities {
        /// <summary>
        /// Iran Standard Time
        /// </summary>
        ...
        public static DateTimeOffset g (this DateTimeOffset dateTimeOffset, string persianDate) {
            string value = "۱۳۹۸-۰۳-۲۱ ۰۷:۳۹:۱۶";
            DateTimeOffset dt = DateTimeOffset.Parse (value, new CultureInfo ("fa-IR"));
            return dt;
        }
