...
namespace CldLayer.Persian {
    ...
    public static class PersianCulture {
        ...
        /// </summary>
        public static readonly IDictionary<DayOfWeek, string> PersianDayWeekNames =
            new Dictionary<DayOfWeek, string> { { DayOfWeek.Saturday, "شنبه" },
        ...
        /// </summary>
        public static readonly IDictionary<int, string> PersianMonthDayNumberNames =
            new Dictionary<int, string> { { 1, "یکم" },
                { 2, "دوم" },
                { 3, "سوم" },
                { 4, "چهارم" },
                { 5, "پنجم" },
        ...
        /// </summary>
        public static readonly IDictionary<int, string> PersianMonthNames =
            new Dictionary<int, string> { { 1, "فروردین" },
                { 2, "اردیبهشت" },
                { 3, "خرداد" },
                { 4, "تیر" },
                { 5, "مرداد" },
        ...
        #region :: GetPersianYearStartAndEndDates ::
        /// <summary>
