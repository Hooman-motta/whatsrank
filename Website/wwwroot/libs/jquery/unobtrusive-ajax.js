...
!(function (t) {
    ...
    function i(i, u) {
        ...
        if (((o = i.getAttribute("data-ajax-confirm")), !o || window.confirm(o))) {
            (c = t(i.getAttribute("data-ajax-loading"))),
                ...
                e(d) || ((u.type = "POST"), u.data.push({ name: "X-HTTP-Method-Override", value: d }));
            var p = t(i);
    ...
    t(document).on("click", "a[data-ajax=true]", function (t) {
        ...
        t(document).on("submit", "form[data-ajax=true]", function (a) {
            ...
            a.preventDefault(), (n || u(this)) && i(this, { url: this.action, type: this.method || "GET", data: e.concat(t(this).serializeArray()) });
        });
})(jQuery);
